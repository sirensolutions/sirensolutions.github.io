...
For more information, see the [documentation](https://download.siren.io/plugins/siren-consolidator/siren-consolidator.pdf).
...
| --- | --- |
| 7.11.2 | [7.11.2-1.0.0](https://download.siren.io/plugins/siren-consolidator/siren-consolidator-7.11.2-1.0.0.zip) |
